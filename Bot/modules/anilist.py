# module to get anime info by t.me/Nekoid // find him on github :  https://github.com/NekoId // he's my doraemon btw.
...
def t(milliseconds: int) -> str:
    """Enter the time in milliseconds, to beautify the time,
      as a rope"""
